...
function Landing() {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://images.pexels.com/photos/32703696/pexels-photo-32703696.jpeg')",
      }}
    >
      {/* Top‐left stats */}
      <div className="absolute top-42 left-8 space-y-4 text-white md:grid-cols-3 md:grid">
        <div className="flex flex-col my-[10px] mx-[16px]">
        ...
        <div className="flex flex-col my-[10px] mx-[16px]">
          ...
          <span className="text-lg">Opencall rewarded</span>
        </div>
        <div className="flex flex-col my-[10px] mx-[16px]">
